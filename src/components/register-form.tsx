  ...
  return (
    <form action={formAction} className="w-3/4 mx-auto md:w-2/5">
        ...
        <div className="relative z-0 w-full mb-5 group">
          ...
          <div aria-live="polite" aria-atomic="true">
            {formState.errors?.confirmPassword &&
              formState.errors.confirmPassword.map((error: string) => (
                <p className="mt-2 text-sm text-red-500" key={error}>
                  {error}
                </p>
              ))}
      ...
      <FormSubmitButton
        ...
        classes="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-full px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mt-6"
      ></FormSubmitButton>
    </form>
  );
}
